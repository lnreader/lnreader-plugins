...
class FenrirRealmPlugin implements Plugin.PluginBase {
  ...
  async parseChapter(chapterPath: string): Promise<string> {
    ...
    // Đã thay đổi: Dùng class .content-area
    let chapter = loadCheerio(page)('.content-area');
            ...
            if (apiRes.ok) {
              ...
              if (Array.isArray(chaptersArray)) {
                ...
                if (correctChapter) {
                  ...
                  // Đã thay đổi: Dùng class .content-area cho phần dự phòng
                  chapter = loadCheerio(page)('.content-area');
                }
              }
            }
          } catch (e) {
